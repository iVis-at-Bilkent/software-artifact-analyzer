...
export class UnassignedBugsComponent implements OnInit, QueryComponent<Anomaly> {
  ...
  loadTable(skip: number, filter?: TableFiltering) {
    ...
    const orderExpr = this._h.getOrderByExpression4Query(filter, 'issue', 'asc', ui2Db);
