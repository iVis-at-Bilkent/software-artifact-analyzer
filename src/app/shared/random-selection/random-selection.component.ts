...
import { TableViewInput, property2TableData, TableData, TableDataType, TableFiltering, TableRowMeta } from '../table-view/table-view-types';
import { Subject, Subscription } from 'rxjs';
import { Neo4jEdgeDirection, GraphElem, HistoryMetaData, ElemAsQueryParam, DbResponseType } from '../../visuall/db-service/data-types';
...
export class RandomSelectionComponent implements OnInit, OnDestroy {
  ...
  tableInput: TableViewInput = {
    columns: ['Title'], results: [], results2: [],isEmphasizeOnHover: true, tableTitle: 'Query Results', isShowExportAsCSV: true,
